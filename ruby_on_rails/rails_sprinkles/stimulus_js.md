...
Wasn't this supposed to be a JavaScript lesson? Yes, but the point is that
...
- When you want functionality, where a roundtrip to a server would not make
sense
</details>
...
- By using abstract controllers, like `toggle`, rather than one specific to the
  view, like `reveal-comments`
